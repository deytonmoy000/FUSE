		...
		do
			...
			do
				...
				do
					...
					cmd0="mkdir -p results_paper_Shenzen/GS_${gs}m/TF_${tf}/Div_${nDiv}/Rep_${seed}"
					echo $cmd0
					$cmd0

					cmd1="mkdir -p figs_paper/GS_${gs}m/TF_${tf}/Div_${nDiv}/Rep_${seed}/${alg}"
					echo $cmd1
					$cmd1

					cmd="python main_shenzen.py ${nDiv} ${tf} ${alg} ${seed} ${gs}"
					echo $cmd
					$cmd
