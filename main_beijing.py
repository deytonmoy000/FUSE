...
from algs_beijing import FUSE_DQN_Train, FUSE_DQN_Test, FUSE_DQN_Train_wo12, FUSE_DQN_Train_wo34, FUSE_DQN_Train_wo5, FUSE_DQN_Test_wo12, FUSE_DQN_Test_wo34, FUSE_DQN_Test_wo5, TSMTC, REASSIGN, AGD, SDPR
if __name__ == "__main__":
    ...
    data_fname = f'data/data_beijing_updated_{grid_size}m.csv'
